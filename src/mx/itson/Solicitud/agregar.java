...
public class agregar {
    ...
    JOptionPane.showMessageDialog(null, "La fecha es el "+dia+" / "+mes+" / "+ año);
    JOptionPane.showMessageDialog(null, "Ah seleccionado el genero: "+sexo);
    JOptionPane.showMessageDialog(null, "Selecciono el estado de: "+estado);
